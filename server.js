...
<body>
	<div id="page">
		<div id="body">
			...
			<div class="body">
				<img src="images/pic1-horz2.jpg" alt="">
			</div>
			<div class="footer">
				<div class="sidebar">
					<h1>My Ideal</h1>
					<p>Beginnings are usually scary, and endings are usually sad, but its everything in between that makes it all worth living.</p>
					<p>- Bob Marley -</p>
				</div>
				<div class="article">
					<h1>About Me</h1>
					<p>Hi! guys, Welcome to my website. My name is Uraiporn Kheerot. My nickname is carrot. My student code 58030249</p>
				</div>
			</div>
		</div>
		<div id="footer">
			<div>
				<div class="connect">
						<a href="https://https://web.facebook.com/uraiporn.kheerot/" class="facebook">facebook</a>
				</div>
				<p>Directed by Uraiporn Kheerot 58030249. And And these is way to contact with me.</p>
			</div>
		</div>
	</div>
</body>
